...
<div class="container-fluid">
    ...
    <!-- mx-auto : card center -->
        ...
        <form method="POST" action="<?= base_url('admin/laporan_absensi/cetak_laporan_absensi')?>">
            ...
            <div class="card-body">
                ...
                <hr>
                <button style="width:100%"type="submit" class="btn btn-primary"><i class="fas fa-print mr-2"></i>Cetak Laporan Absensi</button>
            </div>
        </form>
    </div> 
