...
<div class="container-fluid">
    ...
    <!-- mx-auto : card center -->
        ...
        <form method="POST" action="<?= base_url('admin/laporan_gaji/cetak_laporan_gaji')?>">
            ...
            <div class="card-body">
                ...
                <hr>
                <button style="width:100%"type="submit" class="btn btn-primary"><i class="fas fa-print mr-2"></i>Cetak Laporan Gaji</button>
            </div>
        </form>
    </div> 
