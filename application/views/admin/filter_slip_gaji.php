...
<div class="container-fluid">
    ...
    <!-- mx-auto : card center -->
        ...
        <form method="POST" action="<?= base_url('admin/slip_gaji/cetak_slip_gaji')?>">
            ...
            <div class="card-body">
                ...
                <hr>
                <button style="width:100%"type="submit" class="btn btn-primary"><i class="fas fa-print mr-2"></i>Cetak Slip Gaji</button>
            </div>
        </form>
    </div> 
